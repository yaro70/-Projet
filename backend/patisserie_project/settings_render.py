...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'patisserie-backend.onrender.com,patisserie-frontend-mm13.onrender.com').split(',')
...
# Configuration WhiteNoise pour servir les fichiers media
...
# Security Settings - Désactivés temporairement pour le debug
